  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary: "border border-[var(--app-border)] bg-[var(--app-muted-panel)] text-foreground hover:border-primary/35",
        ghost: "text-foreground hover:bg-[var(--app-muted-panel)]",
        outline: "border border-[var(--app-border)] bg-[var(--app-panel-strong)] text-foreground shadow-sm hover:border-primary/35 hover:bg-[var(--app-muted-panel)]",
